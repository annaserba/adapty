export default {
  ...
  hero: {
    badge: 'Guide',
    badgeText: 'How to grow to $100K | Download',
    title: 'Platform for mobile app growth',
    description: 'Save months on subscription implementation and double your app revenue with effective paywall management.',
    emailPlaceholder: 'Email address',
    startButton: 'Start',
    demoButton: 'Schedule demo',
  },
  trustedBy: {
    text: "Trusted by 15,000+ apps and the world's largest app publishers",
  },
  features: {
    ...
    section1: {
      ...
      testimonials: [
        {
          text: 'We increased our revenue by 40% in just 3 months using Adapty\'s A/B testing features.',
          author: 'Sarah Chen',
          role: 'Product Manager at FitApp',
        },
        {
          text: 'The ability to test paywalls without releasing updates saved us months of development time.',
          author: 'Mike Johnson',
    ...
    section2: {
      ...
      testimonial: {
        text: 'Adapty helped us reduce churn by 60% with automated retry logic and grace periods.',
        author: 'Emma Wilson',
        role: 'Growth Lead at StreamApp',
      },
    },
    section3: {
      ...
      testimonial: {
        text: 'The analytics dashboard gives us complete visibility into our subscription metrics in real-time.',
        author: 'David Park',
        role: 'CEO at LearnApp',
      },
    },
    section4: {
      ...
      testimonial: {
        text: 'The no-code builder let our marketing team create and test paywalls without bothering developers.',
        author: 'Lisa Martinez',
        role: 'Marketing Director at HealthApp',
      },
    },
  },
  pricing: {
  ...
  helpTeam: {
    ...
    steps: {
      configuring: 'Configuring platforms',
      installing: 'Installing Adapty SDK',
      processing: 'Processing purchasing events',
    },
    forDevelopers: {
  ...
  testimonials: {
    ...
    items: [
      ...
      {
        text: 'Adapty has been instrumental in scaling our subscription business. The A/B testing features alone have helped us increase revenue by 40% in just a few months.',
        author: 'Sarah Chen',
      ...
      {
        text: 'The analytics dashboard is incredibly powerful. We can see exactly what\'s working and what\'s not in real-time, which has been game-changing for our business.',
        author: 'David Park',
        role: 'CEO',
        company: 'LearnApp',
        image: '',
      ...
      {
        text: 'Integration was seamless and the support team has been amazing. They helped us migrate from our old system without any downtime.',
        author: 'Emma Wilson',
        role: 'Growth Lead',
        company: 'StreamApp',
        image: '',
      ...
      {
        text: 'The no-code paywall builder is a game changer. Our marketing team can now test different offers without waiting for developers.',
        author: 'Lisa Martinez',
  ...
  footer: {
    cta: {
      title: 'Get started today or schedule a demo for your personal onboarding',
