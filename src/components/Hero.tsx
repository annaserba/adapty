        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 rounded-full text-purple-700 text-sm font-medium">
              <span className="px-2 py-0.5 bg-white rounded">Гайд</span>
              <span>Как вырасти до $100K | Скачать →</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-xl">
              Сэкономьте месяцы на внедрении подписок и удвойте доход от приложения благодаря эффективному управлению приволлами.
            </p>
